...
import { initializeFabric, handleCanvasMouseDown, handleResize, handleCanvasMouseUp, renderCanvas, handleCanvasObjectModified, handleCanvaseMouseMove, handleCanvasSelectionCreated,handleCanvasObjectMoving } from "@/lib/canvas";
